...
public class SandStorm : BackgroundScene, INotifyWhenRoomIsReady
{
                ...
                for (int k = 0; k < this.room.physicalObjects[i][j].bodyChunks.Length; k++)
                {
                    ...
                    if (num > 0f)
                    {
                        ...
                        else
                        {
                            ...
                            bodyChunk2.vel.y = bodyChunk2.vel.y - Mathf.Pow(UnityEngine.Random.value, 5f) * 1.5f * num / bodyChunk.mass;
                        }*/
    ...
    {
        // Token: 0x0600092C RID: 2348 RVA: 0x000567F4 File Offset: 0x000549F4
        ...
        // (get) Token: 0x0600092D RID: 2349 RVA: 0x000568BA File Offset: 0x00054ABA
        ...
        // Token: 0x0600092E RID: 2350 RVA: 0x000568CC File Offset: 0x00054ACC
        public override void Update(bool eu)
        {
            this.vel *= 0.99f;
        ...
        // Token: 0x0600092F RID: 2351 RVA: 0x00056D3C File Offset: 0x00054F3C
        public override void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            sLeaser.sprites = new FSprite[1];
            sLeaser.sprites[0] = new FSprite("pixel", true);
        ...
        // Token: 0x06000930 RID: 2352 RVA: 0x00056E58 File Offset: 0x00055058
        public override void DrawSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
        {
            sLeaser.sprites[0].x = Mathf.Lerp(this.lastPos.x, this.pos.x, timeStacker) - camPos.x;
            sLeaser.sprites[0].y = Mathf.Lerp(this.lastPos.y, this.pos.y, timeStacker) - camPos.y;
        ...
        // Token: 0x06000931 RID: 2353 RVA: 0x00056F54 File Offset: 0x00055154
        public override void ApplyPalette(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, RoomPalette palette)
        {
        ...
        // Token: 0x06000932 RID: 2354 RVA: 0x00056FB7 File Offset: 0x000551B7
