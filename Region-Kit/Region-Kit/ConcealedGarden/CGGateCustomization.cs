...
namespace RegionKit.ConcealedGarden
{
    internal class CGGateCustomization : UpdatableAndDeletable, IDrawable
    {
        ...
        {
            POM.PlacedObjectsManager.RegisterFullyManagedObjectType(new POM.PlacedObjectsManager.ManagedField[]
            {
                new POM.PlacedObjectsManager.BooleanField("noleft", false, displayName:"No Left Door"),
