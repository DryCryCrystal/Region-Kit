...
namespace RegionKit.TheMast
{
    ...
    {
        public static AbstractPhysicalObject.AbstractObjectType PearlChain;
        public static PlacedObject.Type PlacedPearlChain;
        public static SLOracleBehaviorHasMark.MiscItemType MiscItemPearlChain;
        public static SLOracleBehaviorHasMark.MiscItemType MiscItemSinglePearlChain;
    }
    ...
    internal static class PearlChains
    {
        ...
        public static void MoonConversation_AddEvents(On.SLOracleBehaviorHasMark.MoonConversation.orig_AddEvents orig, SLOracleBehaviorHasMark.MoonConversation self)
        {
            ...
            if(self.id == Conversation.ID.Moon_Misc_Item)
            {
                ...
                self.State.miscItemsDescribed[(int)EnumExt_PearlChains.MiscItemSinglePearlChain] = true;
                self.State.miscItemsDescribed[(int)EnumExt_PearlChains.MiscItemPearlChain] = true;
            }
        }
